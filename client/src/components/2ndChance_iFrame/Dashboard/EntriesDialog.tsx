...
interface RaffleListItem { name: string; entries: number }
type RaffleList = RaffleListItem[];

interface TicketListItem { alphaCode: string; availableEntries: number; raffles: [] }
                ...
                >
                    <Box sx={{ width: '100%' }}>
                        ...
                        <CustomTabPanel value={value} index={0}>
                            ...
                            <Box sx={{ marginBottom: '8px', borderBottom: 1, borderColor: 'divider' }} >
                                <Grid2
                                    container
                                    spacing={2}
                                    columns={12}
                            ...
                            >
                                {
                                    ticketList.length > 0 && ticketList.map(x => (
                                        <>
                        ...
                        <CustomTabPanel value={value} index={1}>
                            ...
                            >
                                {
                                    raffleList.length > 0 && raffleList.map(x => (
                                        <>
                                            <Grid2 size={{ xs: 9, sm: 9, md: 9, lg: 9 }}>
                                                <Typography sx={{
                                                    color: "#81858c !important",
