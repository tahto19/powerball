...
const main = () => {
    ...
    return (
        <>
            ...
            <Card sx={{ borderRadius: '15px', overflow: 'auto', padding: 0, border: 'transparent' }}>
                <Box sx={{
                    width: '100%',
                    height: '100px',
                    flexShrink: '0',
                ...
                <Box sx={{ background: '#fff', padding: '35px', display: "flex", flexDirection: 'column' }}>
                    <Box sx={{
                        marginBottom: '35px',
                        display: 'flex',
                        alignItems: 'center',
                        ...
                        <Box sx={{
                            ...
                            <Button onClick={handleOpenDialog} className="overlay" style={{
                                position: 'absolute',
                                display: 'none',
                        ...
                        <Box>
                            <Typography sx={{
                                ...
                                fontSize: '20px',
                                fontWeight: '500',
                            }}>{formData.fullname}</Typography>
                            <Typography sx={{
                                color: '#000',
                                fontSize: '16px',
                                fontWeight: '400',
                                opacity: '0.5'
                            }}>{formData.emailAddress}</Typography>
                        </Box>
                    </Box>
            ...
            <ProfileDialog open={open} fileInfo={formData.fileInfo} onClose={handleClose} onSubmit={handleSubmitImage} />
        </>
    )
}
